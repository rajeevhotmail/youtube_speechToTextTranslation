...
def generate_poem(username, message):
    ...
    prompt = f"Write a 4-line hostile poem for a live chat user. The user's name is {username}, and their message is: '{message}'. Make the poem grim and engaging."
    try:
