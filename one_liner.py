...
def generate_witty_onliner_urdu(username, message):
    ...
    prompt = f"Write a single witty and complimentary for a live chat user in urdu or roman urdu. The user's name is {username}, and their message is: '{message}'. The response should be polite, complimentary, engaging, and creative."
...
def generate_witty_onliner_hindi(username, message):
    """Generate a 1-line witty remark for a live chat user based on their name and message."""
    prompt = f"Write a single witty and grim remark for a live chat user in Hindi. The user's name is {username}, and their message is: '{message}'. The response should be sharp, engaging, and creative. the input can be in hindi language or roman hindi or English"
...
def detect_and_warn_abuse(live_chat_id, messages, start_time):
    ...
    for message in messages:
        ...
        if normalized_author_name in target_users:
            ...
            poem = generate_witty_onliner_urdu(raw_author_name, user_message)
            poem = ":robot: " + poem
           ...
           # poem = poem + " (a sinister sneer ensues ) he he he he he"
            ...
            poem_hindi = " 🤖( " + message_time.strftime('%Y-%m-%d %H:%M:%S') + " ) " + poem_hindi
